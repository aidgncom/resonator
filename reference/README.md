...
This directory is reserved for language and platform implementations of BEAT interpreters. Implementations placed here serve as reference examples for how BEAT sequences may be interpreted in different environments.

The authoritative definition of BEAT and its eight-state semantic layout is provided in the repository root README. Interpreters in this directory are reference adaptations of that specification and must preserve the same semantic stream for any BEAT sequence.

For licensing and compatibility obligations, refer to the Compatibility section in the root README and the applicable GPL-3.0-or-later and AGPL-3.0-or-later terms.
